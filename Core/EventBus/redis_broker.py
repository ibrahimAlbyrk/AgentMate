...
This module provides a Redis-based implementation of the MessageBroker
interface for the EventBus system.
"""
...
from Core.EventBus.broker import MessageBroker, MessageCallback
            ...
            while True:
                ...
                if message:
                    ...
                    if channel in self.subscribers:
                        try:
                            # Convert Redis message to Message object
...
# Register the Redis broker with the factory
