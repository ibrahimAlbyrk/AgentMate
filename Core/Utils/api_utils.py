"""
API Utilities for AgentMate

This module provides utilities for working with API responses and handling
common API-related tasks.
"""

from typing import Dict, Any, TypeVar, Callable, Optional, Generic, Union, List, Type
import json
import logging
...
class APIResponseHandler:
    ...
    def __init__(self, logger_name: str = "APIResponseHandler"):
        """
        Initialize the API response handler.
