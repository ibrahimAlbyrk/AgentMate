"""
Exception Hierarchy for AgentMate

This module defines a hierarchy of custom exceptions for the AgentMate application.
These exceptions provide a standardized way to handle and report errors throughout
the application.
"""
